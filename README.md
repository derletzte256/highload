...
(3) Максимальная длина клина - 60 секунд [^10], 6000 * 60 = 45 МБ для одного клипа. 45 МБ * 500К = 21,47 ТБ в день на всех пользователей.

### Сетевой трафик


| Тип | RPS | Пиковый суточный трафик (Гбит/c) | Суммарный суточный трафик (Гбит/c) |
| --- | --------- | -------------------- | ---------------------------- | ------------- |
| Регистрация/авторизация | ~0 | - | - | - |
| Стриминг (время) | 
| Стриминг (количество) | 
| Просмотр стрима (время) | 
| Просмотр стрима (количество) |
| Подписка | 
