...
#### SSL Termination
Для рассчета трафика используем максимальное из необходимого трафика для SSL и по нагрузке
### Резервирование
...
Допущения:
- L4 сервер имеет пропускную способность 100 Гбит/c

| Расположение ДЦ   | Регион        | Гбит/с | N (L4) |
| ----------------- | ------------- | -----  | ----- |
| Франкфурт         | Европа        |   1040 | 12    |
| Ашберн, Вирджиния | США (Восток)  |    762 | 9 |
| Огайо             | США (Восток)  |    762 | 9 |
| Портленд, Орегон  | США (Запад)   |    762 | 9 |
| Стокгольм         | Европа        |    610 | 8 |
| Париж             | Европа        |    583 | 7 |
| Мадрид            | Европа        |    368 | 5 |
| Сан-Паулу         | Южная Америка |    359 | 5 |
| Лондон            | Европа        |    314 | 4 |
| Милан             | Европа        |    305 | 4 |
| Ирландия          | Европа        |    305 | 4 |
| Мумбаи            | Азия          |    305 | 4 |
| Сеул              | Азия          |    305 | 4 |
| Гонконг           | Азия          |    305 | 4 |
| Осака             | Азия          |    305 | 4 |
