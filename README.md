...
| Подписка | 0.142 | 5М | при допущении, что пользователь подписывается раз в неделю |
...
| --- | --------- | -------------------- |
| Регистрация/авторизация | < 1 | - |
| Стриминг |  7.26M | 90 |
| Просмотр стрима | 180M | 18000 |
| Подписка | < 1 | - |
| Отправка сообщения в чат | 1000 [^8] | - |
| Создание VOD (1) | 0 | 0 |
| Создание клипа | 5 | - |
| Просмотр VOD/клипа | 10 | 1 |
