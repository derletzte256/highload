...
Могут возникать проблемы с RTMP соединением (stateful), так как при смене маршрута до Anycast IP трафик может перейти в другой узел, что приведет к разрыву сесии.
