...
| Chat | 1 соединение | 25 000 | WebSocket, упор на RAM |
| Edge Node | 1 Гбит/c | 4 | Лимит не в CPU, а в пропускной способности |
| Transcode | 1 Stream | 0.5 стрима | Транскодинг 1080p в 4 качества (CPU x264) |
...
1.  Видео-процессинг (Ingest + Transcoding):
    - Самая тяжелая часть. Транскодинг 89 000 потоков в 4 качества требует огромных мощностей.
...
## Конфигурации серверов и итоговая смета
Для унификации выбираем 3 типа серверов на базе AMD EPYC (выгодное соотношение цена/ядро). Закладываем резерв 20%.

### Тип 1 (Ingest + Транскодинг)
- Задача: Ingest потоков и тяжелый транскодинг x264.
- Spec: 2x EPYC 7C13 (128 ядер / 256 потоков), 256 GB RAM.
- Мощность: 60 стримов полного цикла на сервер.
- Расчет: 89 000 / 60 * 1.2 ≈ 1 780 серверов.
- Стоимость: ~1250$ в месяц

### Тип 2: (Edge)
- Задача: Отдача HLS чанков зрителям, кэширование.
- Spec: 1x AMD EPYC 7402P (24 ядра), 128 GB RAM, 2x25 Gbps Uplink.
- Мощность: 40 Гбит/с эффективного трафика.
...
| :--- | :--- | :--- | :--- |
| Transcoder | 128 Cores / 256 GB / 20G | 1 780 | Обеспечение транскодинга для 100% стримов (89k) |
| Edge | 24 Cores / 128 GB / 50G | 252 | Исходящий трафик 8.4 Тбит/с |
| App & DB | 32 Cores / 256 GB / 20G | 50 | Бизнес-логика, чат, хранение данных |
| ВСЕГО | | 2 082 | 20% запаса включено |

### Итоговая оценка стоимости
| Категория серверов | Конфигурация | Количество | Цена аренды за шт. (мес) | Общая стоимость (мес) |
| :--- | :--- | :--- | :--- | :--- |
| Transcoder Node | 2x AMD EPYC 7763 (128 cores), 256 GB RAM | 1780 | 1 200 USD | 2 136 000 USD |
| Edge CDN Node | 1x AMD EPYC 7402P (24 cores), 128 GB RAM, 50G Net | 252 | 1 650 USD | 415 800 USD |
| App & DB Node | 1x AMD EPYC 7502P (32 cores), 256 GB RAM | 50 | 350 USD | 17 500 USD |
| Итого | | 2082 | | 2 569 300 USD |
